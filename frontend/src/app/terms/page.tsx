                ...
                <div className="prose prose-gray max-w-none">
                  <section className="mb-8">
                    ...
                    <p className="text-[#37322F] text-base leading-6 font-sans mb-4">
                      By accessing and using vibeitagnetss (&quot;the Service&quot;),
                  ...
                  <section className="mb-8">
                    ...
                    <p className="text-[#37322F] text-base leading-6 font-sans mb-4">
                      vibeitagnetss is a platform for building, deploying, and managing
                  ...
                  <section className="mb-8">
                    ...
                    <p className="text-[#37322F] text-base leading-6 font-sans mb-4">
                      ...
                      functionality are owned by vibeitagnetss and are protected by
                  ...
                  <section className="mb-8">
                    ...
                    <p className="text-[#37322F] text-base leading-6 font-sans mb-4">
                      In no event shall vibeitagnetss be liable for any indirect,
